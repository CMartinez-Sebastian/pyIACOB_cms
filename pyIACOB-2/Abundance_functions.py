...
class abundance_determination():
    ...
    def line_measurement(self,lines,save=True,fitfunc='g',path = '/media/cms/Elements/PhD/DATA/FASTWIND',
    ...
    def abundance_determination_func(self,elem,model,vsini,vmac,SpC='Unknown',observed_EW_dic=False,
                                fix_micro = False,mic_L = False,scatter_minimum = True,\
                                step_number_abundance=420,step_number_microturbulence = 30,save_im = False,\
                                save_im_path = '/media/cms/Elements/PhD/DATA/FASTWIND/IMAGES/',extra=''):
        '''
        ...
        observed_EW_dic : TYPE, optional
            DESCRIPTION. The default is False.
        fix_micro : TYPE, optional
            DESCRIPTION. The default is False.
        mic_L : TYPE, optional
            DESCRIPTION. The default is False.
        scatter_minimum : TYPE, optional
            DESCRIPTION. The default is True.
        step_number_abundance : TYPE, optional
            DESCRIPTION. The default is 420.
        step_number_microturbulence : TYPE, optional
            DESCRIPTION. The default is 30.
        save_im : TYPE, optional
            DESCRIPTION. The default is False.
        save_im_path : TYPE, optional
            DESCRIPTION. The default is '/media/cms/Elements/PhD/DATA/FASTWIND/IMAGES/'.
        extra : TYPE, optional
        ...
        if observed_EW_dic is False:
            observed_EW_dic = pd.read_csv('/media/cms/Elements/PhD/DATA/FASTWIND/star_analysis/'+star+'_N_gc.csv')
        ...
        ### Charging FW model ###
        with open(dir().fastwinddir+dir().fastwinddir.split('/')[-2]+'_pkl/original/'+self.model+elem+'_lines.pkl','rb') as inp:
